...
def facereader_landmarks_reps(GENERAL_DIR, syn_name):
    ...
    # location to save representation
    csv_syn_selected = GENERAL_DIR+ "\\{}\\representations\{}-patients-facereader-landmarks-distances.csv".format(syn_name, syn_name)
    csv_ID_selected = GENERAL_DIR+ "\\{}\\representations\ID-controls-facereader-landmarks-distances.csv".format(syn_name)
    ...
    print("Done with saving all facereader-landmark-distances representations for {}.".format(syn_name))
