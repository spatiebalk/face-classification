...
def facereader_reps(GENERAL_DIR, syn_name, control):
    ...
    csv_file_syn = GENERAL_DIR+ "\\{}-{}\\representations\{}-patients-facereader.csv".format(syn_name, control, syn_name)
    csv_file_ID = GENERAL_DIR+ "\\{}-{}\\representations\{}-controls-facereader.csv".format(syn_name, control, control)
