...
def main(GENERAL_DIR, syn_name, control, trial_nr):    
    ...
    results_file = open("results/{}-{}/{}-{}-results-run-{}-{}.txt".format(syn_name, control, syn_name, control, trial_nr, today), "w")
    results_file.write("Syndrome that will be classified: {} with controls: {} \n\n".format(syn_name, control))
    print("Syndrome that will be classified: {} with controls: {} \n\n".format(syn_name, control))
    ...
    for data_combination in [0,1, 2, 7, 8]: #, 4, 5, 6, 7, 8]: 
        ...
        nr_comps, data, labels = concatenate(syn_name, control, data_dir, data_combination, nr_feats) 
