...
def openface_cfps_reps(GENERAL_DIR, syn, control):
    ...
    for method in ["openface", "cfps"]:
        ...
        csv_file_syn = GENERAL_DIR+ "\\syn_vs_syn\\{}-{}\\representations\{}-patients-{}.csv".format(syn, control, syn, method)
        csv_file_ID = GENERAL_DIR+ "\\syn_vs_syn\\{}-{}\\representations\{}-controls-{}.csv".format(syn, control, control, method)
