...
def deepface_reps(GENERAL_DIR, syn_name, control):
    ...
    csv_file_syn = GENERAL_DIR+ "\\{}-{}\\representations\{}-patients-deepface.csv".format(syn_name, control, syn_name)
    csv_file_ID = GENERAL_DIR+ "\\{}-{}\\representations\{}-controls-deepface.csv".format(syn_name, control, control)
    ...
    print("Done with saving all deepface representations for {}-{}.".format(syn_name, control))
